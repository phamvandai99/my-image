...
class zLocket:
    def __init__(self, device_token: str="", target_friend_uid: str="", num_threads: int=1, note_target: str=""):
        ...
        self.PROXY_LIST=[
             'https://raw.githubusercontent.com/daifg88/my-image/main/proxies.txt', ' https://api.proxyscrape.com/v4/free-proxy-list/get?request=display_proxies&protocol=http&proxy_format=protocolipport&format=text&timeout=20000 ',' https://api.proxyscrape.com/v4/free-proxy-list/get?request=display_proxies&protocol=http&proxy_format=protocolipport&format=text&timeout=20000 ',
        ...
        if os.name == "nt":
            os.system(
                f"title  {self.NAME_TOOL} {self.VERSION_TOOL} by vandai.click "
         )
